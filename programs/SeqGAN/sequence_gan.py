...
positive_file = './applications/%s/SeqGAN/%s' % (prefix,file_name)
negative_file = './applications/%s/SeqGAN/save/generator_sample_%s' % (prefix,file_name)
# eval_file = 'save/eval_file.txt'
eval_file = './applications/%s/SeqGAN/seqGAN_output_%s' % (prefix,file_name)
# generated_num = 10
...
def main():
    ...
    #
    log = open('./applications/%s/SeqGAN/save/experiment-log-%s' % (prefix,file_name), 'w')
    #  pre-train generator
