...
def execute_sequence_gan(name,file_name,generated_num,total_batch,batch_size,seq_length):
    try:
        # generated_num = input('generated_num=')
        # total_batch = input('total_batch=')
        # batch_size = input('batch_size=')
        # seq_length = input('seq_length=')
        print('python ./programs/SeqGAN/sequence_gan.py --name=%s --filename=%s --generated_num=%s --total_batch=%s --batch_size=%s --seq_length=%s' % (name, file_name,generated_num, total_batch, batch_size, seq_length))
        os.system('python ./programs/SeqGAN/sequence_gan.py --name=%s --filename=%s --generated_num=%s --total_batch=%s --batch_size=%s --seq_length=%s' % (name, file_name, generated_num, total_batch, batch_size, seq_length))
        # logging.info(output)
...
execute_sequence_gan(prefix,file_name,generated_num,total_batch,batch_size,seq_length)
